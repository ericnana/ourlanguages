...
class RegionsCarousel extends StatefulWidget {
  RegionsCarousel() : super();
  @override
  _OurRegionsCarousel createState() => _OurRegionsCarousel();
}

class _OurRegionsCarousel extends State<RegionsCarousel> {
